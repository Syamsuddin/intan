<?php
#######################################################################
######  Nama file : tambahjadwal.php								#######
######  Programmer: syamsuddin									#######
######  Lisensi	  : gpl											#######
######  Dibuat    : 29 Oktober 2016, 09:42 WITA					#######
######  Deskripsi : berisi halaman input jadwal kegiatan baru	#######
#######################################################################
	include 'config.php';
	$title  = 'Tambah Jadwal';
	include 'header.php';
		...
		<form method="post" action="prosestambahjadwal.php">
            <table width="682" border="1">
              ...
              <tr>
                ...
                <td>:</td>
                <td><label>
                  <input name="Tanggal" type="text" id="tanggal" maxlength="10" readonly>&nbsp; (yyyy/mm/dd)
                </label></td>
              </tr>
              <tr>
                <td>Hari</td>
              ...
              <tr>
                <td>Waktu</td>
                <td>:</td>
                <td><input name="Waktu" type="text" id="Waktu" maxlength="10">WITA, &nbsp; Format : ((hh:mm:ss), contoh 07:30:00</td>
              </tr>
              <tr>
                <td>Tempat</td>
                <td>:</td>
